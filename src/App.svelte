<script lang="ts">
  ...
  const avgMs = $derived(
    history.length
      ? history.reduce((sum, h) => sum + h.timeMs, 0) / history.length
      : null,
  );
            ...
            {:else if finished}
              ...
              >
                ...
                {:else}
                  ...
                  {#if bestEntry && worstEntry && avgMs !== null}
                    <div
                    ...
                    >
                      ...
                      <div class="flex items-center gap-3">
                        ...
                        >
                        <span
                          class="text-base font-bold tabular-nums min-w-12 text-navy"
                          >{(avgMs / 1000).toFixed(1)}s</span
                        >
                      </div>
                      <div class="flex items-center gap-3">
                        <span class="text-[0.85rem] text-[#666] w-24 shrink-0"
