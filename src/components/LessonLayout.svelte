...
<div class="max-w-3xl mx-auto px-6 py-8">
  ...
  <div class="mt-12 pt-6 border-t border-[#e8e6e0] flex items-center justify-center gap-3">
    ...
    {:else}
      ...
      >
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" class="inline-block"><polyline points="20 6 9 17 4 12" /></svg> Completed
      </button>
    {/if}
    {#if nextLesson}
      <button
