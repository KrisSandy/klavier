  ...
  <section class="mb-10">
    ...
    <div class="space-y-3 mb-4">
      ...
      <div class="flex gap-3 items-start">
        ...
        <div>
          <p class="text-[#444]"><strong>Mark your fingering.</strong> Go through the piece and write finger numbers on tricky passages before you start practising — this saves time and reduces reliance on looking at your hands.</p>
        </div>
      </div>
      <div class="flex gap-3 items-start">
      ...
      <div class="flex gap-3 items-start">
        <span class="text-purple font-bold text-lg shrink-0">6</span>
        <div>
      ...
      <div class="bg-white rounded-lg p-4 border border-[#e8e6e0]">
        <div class="flex items-center gap-3">
          ...
          <div>
            ...
            <p class="text-sm text-[#444]">Play scales (C, G, D, F major + A minor) with correct fingering: RH ascending 1–2–3–1–2–3–4–5, LH descending 5–4–3–2–1–3–2–1. Use the metronome.</p>
          </div>
        </div>
      </div>
      <div class="bg-white rounded-lg p-4 border border-[#e8e6e0]">
