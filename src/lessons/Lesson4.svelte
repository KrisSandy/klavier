  ...
  <section class="mb-10">
    ...
    <div class="bg-[#fdf6ee] border border-[#f0dcc8] rounded-lg p-4 mb-6">
      <p class="text-[#444] leading-[1.7] text-sm">
        <strong>Fingering Tip:</strong> Ode to Joy stays in C position (right hand fingers 1–5 on C, D, E, F, G). Since the melody only uses notes from C through G, no finger repositioning is needed. This makes it a perfect first melody for practicing consistent finger placement — you can focus entirely on reading the notes without worrying about moving your hand around!
      </p>
    </div>
