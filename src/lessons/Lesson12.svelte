...
<LessonLayout {lesson}>
  ...
  <!-- Section 3: Smooth Chord Transitions -->
  <section class="mb-10">
    <h2 class="text-[1.1rem] font-bold text-navy mb-3 pb-2 border-b-2 border-[#dad9d4]">Smooth Chord Transitions</h2>
    <p class="text-[#444] leading-[1.7] mb-4">
      When you play a chord progression, the key to smooth transitions is finding the <strong>common tones</strong> — notes that are shared between consecutive chords. Keep these notes where they are and move only the other fingers.
    </p>
    <div class="space-y-3 mb-4">
      <div class="bg-white rounded-lg border border-[#e8e6e0] p-4">
        <p class="font-semibold text-navy mb-2">C Major → F Major</p>
        <p class="text-sm text-[#666] mb-2"><strong>C chord:</strong> C (finger 1) - E (finger 3) - G (finger 5)</p>
        <p class="text-sm text-[#666] mb-3"><strong>F chord:</strong> F (finger 1) - A (finger 3) - C (finger 5)</p>
        <p class="text-sm text-[#444] mb-2"><strong>What happens:</strong></p>
        <ul class="text-sm text-[#666] space-y-1 pl-5 list-disc">
          <li>Finger 5 stays on C (it moves from top note to bottom note)</li>
          <li>Finger 3 moves from E to A</li>
          <li>Finger 1 moves from C to F</li>
        </ul>
      </div>
      <div class="bg-white rounded-lg border border-[#e8e6e0] p-4">
        <p class="font-semibold text-navy mb-2">C Major → G Major</p>
        <p class="text-sm text-[#666] mb-2"><strong>C chord:</strong> C (finger 1) - E (finger 3) - G (finger 5)</p>
        <p class="text-sm text-[#666] mb-3"><strong>G chord:</strong> G (finger 1) - B (finger 3) - D (finger 5)</p>
        <p class="text-sm text-[#444] mb-2"><strong>What happens:</strong></p>
        <ul class="text-sm text-[#666] space-y-1 pl-5 list-disc">
          <li>Finger 1 moves from C to G (a large jump — look ahead!)</li>
          <li>Finger 3 moves from E to B</li>
          <li>Finger 5 moves from G to D</li>
        </ul>
        <p class="text-sm text-[#444] mt-2"><strong>Tip:</strong> When no notes are shared, consider using an inversion of one chord for a smoother transition.</p>
      </div>
    </div>
    <div class="bg-blue-50 rounded-lg border-l-4 border-blue-400 p-4">
      <p class="text-sm text-[#444]">
        <strong>Practice tip:</strong> Play each chord change slowly and repeatedly before trying the full progression. Once your fingers know the shapes, the transitions will become automatic.
      </p>
    </div>
  </section>

  <!-- Section 4: Common Progressions -->
  <section class="mb-10">
  ...
  <!-- Section 5: Play a Song with Chords -->
  {#if song}
    <section class="mb-10">
